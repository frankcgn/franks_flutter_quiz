...
class OldQuizPage extends StatefulWidget {
  ...
  @override
  _OldQuizPageState createState() => _OldQuizPageState();
}

class _OldQuizPageState extends State<OldQuizPage> with RestorationMixin {
  int currentIndex = 0;
  ...
  @override
  void didUpdateWidget(covariant OldQuizPage oldWidget) {
